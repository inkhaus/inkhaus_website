...
const SmallNav = ({
  ...
  return (
    <div className="w-full h-full fixed top-0 left-0 right-0 z-[1000000] flex items-center justify-center ">
      <AnimatePresence>
        <motion.div
          exit="exit"
          initial={{ y: -30 }}
          ...
          className=" w-full h-screen  bg-[#fff] overflow-y-auto shadow z-[1000000] p-4"
        >
